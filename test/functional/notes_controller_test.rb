...
class NotesControllerTest < ActionController::TestCase
  ...
  test 'first-timer posts note' do
    ...
    assert_equal "<h2>Success! You did it! Hooray!</h2>
      ...
      </p>", flash[:notice]# no double notice
  ...
  test 'post_note_error_no_title_xhr' do
    ...
    assert_equal ["can't be blank", "is too short (minimum is 2 characters)", "can only include letters, numbers, and dashes"], json['title']
